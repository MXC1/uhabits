...
@Inject
class MoodPanelViewFactory(
    @ActivityContext val context: Context,
    val preferences: Preferences,
    private val buttonFactory: MoodButtonViewFactory
) {
    fun create() = MoodPanelView(context, preferences, buttonFactory)
}
...
class MoodPanelView(
    ...
    private val buttonFactory: MoodButtonViewFactory
) : ButtonPanelView<MoodButtonView>(context, preferences) {
